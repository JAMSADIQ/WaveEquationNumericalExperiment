...
def solver(I, V, f, c, L, dx, C, T, user_action=None):
    """
...
def test_quadratic():
    ...
    solver(I, V, f, c, L, dx, C, T, user_action=assert_no_error)
...
def convergence_rates(
    ...
    plt.title("cobvergence with CFL = {0} and fixed dx".format(C))
    plt.loglog()
    plt.grid()
